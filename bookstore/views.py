...
def loginView(request):
    if request.method == 'POST':
        ...
        if user is not None and user.is_active:
            ...
            #checking what kind of user, depending on it we redirect the user to his ashboard
...
#by default all new registered users have the user account of a publisher
...
class LEditView(LoginRequiredMixin, UpdateView):
    ...
    success_message = 'Data was edited successfully'
